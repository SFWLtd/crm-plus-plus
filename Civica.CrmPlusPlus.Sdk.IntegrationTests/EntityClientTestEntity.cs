...
{
    [EntityName("civica_entityclienttest")]
    [EntityInfo("Entity Client Test Entity", OwnershipType.OrganizationOwned)]
    public class EntityClientTestEntity : CrmPlusPlusEntity
    {
